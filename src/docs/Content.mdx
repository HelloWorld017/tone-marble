...
<div class="twocols">
  <div>
    **Used Web APIs**  
    ...
    <div class="taglist">`WebAudio` `WebGL` `WebGPU` `WebMIDI` `WebRTC`</div>
  </div>
  <div>
    **Used Libraries**
    * **UI**  
      <div class="taglist">`react` `react-three` `react-spring` `emotion`</div>

    * **NeuralNets**  
      <div class="taglist">`tensorflowjs`</div>

    * **WebRTC**  
      <div class="taglist">`peerjs`</div>
  </div>
</div>
