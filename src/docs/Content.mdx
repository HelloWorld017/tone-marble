...
Essentially, this project is an experiment to determine if the chaotic nature of physics can sound musical when entropy is reduced — specifically by constraining the pitch.  
...
### Sound Gallery
Sounds used in this project are all synthesized using WebAudio and no audio clips are used.  
...
* **Synthesis Layer**  
  ...
  No audio clips are used in this project.
...
<a className="cta" href="../">Try it now</a>  
<a className="cta secondary" href="https://github.com/HelloWorld017/tone-marble">Source Code</a>  
